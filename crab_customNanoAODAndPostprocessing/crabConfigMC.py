...
'''
cd crab_customNanoAODAndPostprocessing/
crab submit -c crabConfigMC.py
...
config.JobType.inputFiles = ['crab_script_MC.sh', 'Hto4b_postproc_MC.py']
...
config.Data.inputDataset = '/SUSY_WH_WToAll_HToAATo4B_Pt150_M-30_TuneCP5_13TeV_madgraph_pythia8/RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM'
...
config.Data.outLFNDirBase = '/store/user/abrinke1/NanoPost/'
